...
import com.supermart.vstore.exception.VstoreException;
...
public class ExceptionControllerAdvice {
	...
	@ExceptionHandler(VstoreException.class)
	public ResponseEntity<ErrorInfo> ekartExceptionHandler(VstoreException exception) {
		ErrorInfo error = new ErrorInfo();
